...
function swal_notifyDialog(content = "", icon = "info", title = 'Thông báo',) {
	Swal.fire({
		title: title,
		text: content,
		icon: icon,
...
function onSearch(obj) {
	...
	if (keyword == '') {
		swal_notifyDialog('Vui lòng nhập từ khóa', 'warning');
		return false;
	} else {
